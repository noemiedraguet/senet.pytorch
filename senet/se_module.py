...
class SELayer(nn.Module):
    def __init__(self, channel, reduction=16, threshold = 0.5):
        ...
        #Initialisation of the mask that allows skipping residuals for channels put to 0
        self.mask = None
    ...
    def forward(self, x):
        ...
        #The mask takes a value of 0 where the channel has a descriptor value of 0 and 1 otherwise.
        self.mask = (y != 0).float()
